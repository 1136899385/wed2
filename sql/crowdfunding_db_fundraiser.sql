...
INSERT INTO `fundraiser` VALUES (1,'John Doe','Build a school library',5000.00,0.00,'New York',1,1),(2,'Jane Smith','Provide meals for the homeless',3000.00,0.00,'Los Angeles',1,2),(3,'Alice Johnson','Clean up the local park',2000.00,0.00,'Chicago',1,3),(4,'Bob Brown','Fundraise for cancer research',10000.00,0.00,'San Francisco',1,2),(5,'Charlie Davis','Support local artists',1500.00,0.00,'Seattle',1,1);
...
-- Dump completed on 2024-09-28 19:31:38
